...
public interface PoliciesApi {
    ...
    ResponseEntity<List<Policy>> policiesGet();
    ...
    @RequestMapping(value = "/policies/{policyId}",
        ...
        consumes = { "application/json" },
        method = RequestMethod.GET)
    ResponseEntity<Policy> policiesPolicyIdGet(@ApiParam(value = "The ID of the policy to retrieve",required=true) @PathVariable("policyId") String policyId);
    ...
    ResponseEntity<Policy> policiesPost(@ApiParam(value = "The policy to add" ,required=true )  @Valid @RequestBody Policy policy);
